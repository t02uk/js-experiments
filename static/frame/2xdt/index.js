...
(function() {
  ...
  window.onload = function() {
    var Note, Score, VFX, VFXColorShift, VFXFlash, VFXHorizontalSlice, VFXManager, VFXSwapColor, VFXTile, VFXTileSlice, VFXVerticalSlice, d, getUserMedia, instruments, loadAudio, main, measure, score, video, vm, withVendorPrefix, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
    ...
    VFXTile = (function(_super) {
      ...
      function VFXTile() {
        _ref = VFXTile.__super__.constructor.apply(this, arguments);
        return _ref;
      }
    ...
    VFXHorizontalSlice = (function(_super) {
      ...
      function VFXHorizontalSlice() {
        _ref1 = VFXHorizontalSlice.__super__.constructor.apply(this, arguments);
        return _ref1;
      }
    ...
    VFXVerticalSlice = (function(_super) {
      ...
      function VFXVerticalSlice() {
        _ref2 = VFXVerticalSlice.__super__.constructor.apply(this, arguments);
        return _ref2;
      }
    ...
    VFXTileSlice = (function(_super) {
      ...
      function VFXTileSlice() {
        _ref3 = VFXTileSlice.__super__.constructor.apply(this, arguments);
        return _ref3;
      }
    ...
    VFXFlash = (function(_super) {
      ...
      function VFXFlash() {
        _ref4 = VFXFlash.__super__.constructor.apply(this, arguments);
        return _ref4;
      }
    ...
    VFXSwapColor = (function(_super) {
      ...
      function VFXSwapColor() {
        _ref5 = VFXSwapColor.__super__.constructor.apply(this, arguments);
        return _ref5;
      }
    ...
    VFXColorShift = (function(_super) {
      ...
      function VFXColorShift() {
        _ref6 = VFXColorShift.__super__.constructor.apply(this, arguments);
        return _ref6;
      }
    ...
    Note = (function() {
      function Note() {
        var _ref7;
        this.active = false;
        _ref7 = $A(arguments), this.ps = _ref7[0], this.xy = _ref7[1];
      }
      ...
      Note.prototype.isInBound = function(p) {
        var _ref7, _ref8;
        return (this.ps[0][0] <= (_ref7 = p[0]) && _ref7 <= this.ps[1][0]) && (this.ps[1][1] <= (_ref8 = p[1]) && _ref8 <= this.ps[2][1]);
      };
